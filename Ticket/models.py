...
class RaiseTicket(models.Model):
    ...
    msg=models.TextField(max_length=800,blank=False)
    priority= models.CharField(choices=PRIORITY_CHOICES, max_length=50, blank=False,null=True)
    category= models.CharField(choices=CATEGORY, max_length=50, blank=False,null=True)
    subcategory= models.CharField(choices=SUB_CATEGORY, max_length=50, blank=False,null=True)
    ...
    raised_by=models.ForeignKey(User,on_delete=models.CASCADE,related_name='raised_users', blank=True,null=True)
